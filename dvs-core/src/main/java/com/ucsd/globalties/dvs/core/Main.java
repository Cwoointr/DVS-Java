...
public class Main extends Application {
  ...
  public void start(Stage stage) throws Exception {
    ...
    try {
      ...
      // This sets the min an max size for the main Window (Stage)
      // The way we have it set here, the user will not be able to resize the window in any
      // way. The size values are hardcoded for now
